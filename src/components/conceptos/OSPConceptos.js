...
const OSPConceptos = () => {
  return (
    <div className="Info-table">
            <h2 className='title-info-osp'>¿Qué son las OSP?</h2>
            <p className='description-info'>
            El concepto de <span className='mark-bold'>Organización de significado personal</span> es utilizado por la Psicología Cognitiva Posracionalista, para definir al <span className='mark-bold'>ordenamiento de la experiencia inmediata del ser humano</span>, caracterizada por un modo único y personal de agrupar y combinar las tonalidades emocionales básicas, más un sistema explicativo que, en permanente relación funcional con el anterior, intenta hacer consistente esa experiencia en torno a una imagen consciente del sí mismo, que <span className='mark-bold'>otorgue un significado viable a la propia experiencia</span>. Es entendida como un <span className='mark-bold'>proceso</span>, es decir, como una modalidad de procesar el conocimiento, y no como un contenido particular del mismo. 
            </p>
            
            <img src="https://plustatic.com/663/conversions/tipos-personalidad-large.jpg" alt='OSP personalidad' />
            <p className='description-info'>
            Las <span className='mark-bold'>Organización de significado personal</span> encuentran su origen en la teoría psicológica desarrollada por <span className='mark-bold'>Vittorio Guidano</span>. Cada organización de significado personal es única. Se conforma a lo largo del ciclo evolutivo de la persona mediante la estructuración de significados. El significado es lo que le permite al ser humano dar coherencia y sentido de continuidad a su vida. Para ello, se vale del lenguaje, que construye en términos de proposiciones verbales una explicación de la experiencia inmediata que ha percibido. Asimismo, le permite destacar el contenido informativo de lo percibido de la tonalidad afectiva. Para que este proceso se pueda llevar cabo, es necesaria la intersubjetividad, que facilita el conocimiento formal y el autoconocimiento, gracias a la interacción con los otros. Esta interacción hace referencia a la importancia del vínculo humano, principalmente desde el nacimiento y en el período de desarrollo, en el que todo ser humano necesita mantener proximidad física y emotiva, con una figura significativa. La naturaleza del vínculo, es decir, el apego que se desarrolle, determinará a cada organización de significado personal.
            </p>

            <h2 className='description-info'><span className='mark-bold'>Clasificación</span></h2>
            <p className='description-info'>
            <span className='mark-bold'>Organización de significado personal depresiva</span>
            </p>
            <p className='description-info'>
            ...
            <p className='description-info'>El segundo aspecto, implica que el niño percibe a sus padres como inaccesibles. Experimenta esto como un rechazo, organizando así su núcleo central del sí mismo sobre la base de la desesperación -sensación de «ninguno me ayuda, soy inayudable»- y rabia -hacia personas que no le dan acceso-. En este momento el niño se defiende mediante la evitación.</p>
            <p className='description-info'>
            ...
            <p className='description-info'>
              Así, la coherencia interna de una persona depresiva, será en la adultez una paradoja. Por un lado, se lanzará a la búsqueda de un sostén emocional seguro, sin embargo, como no puede concretar momentos de intimidad y los evita, no logra encontrar apoyo emocional estable. La organización de significado personal depresiva para sobrevivir evitará constantemente repetir la experiencia de pérdida.</p>

              <p className='description-info'>
            <span className='mark-bold'>Organización de significado personal fóbica</span>
            </p>
            <p className='description-info'>
            ...
            <p className='description-info'>
            <span className='mark-bold'>Organización de significado personal de los desórdenes alimentarios psicogénicos</span>
            </p>
            <p className='description-info'>
            ...
            <p className='description-info'>
            <span className='mark-bold'>Organización de significado personal obsesiva</span>
            </p>
            <p className='description-info'>
