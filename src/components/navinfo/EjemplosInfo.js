...
const EjemplosInfo = () => {
  return (
    ...
    <h2 className='title-info-others'>Ejemplos de O.S.P. <i class="fa-brands fa-youtube"></i> </h2>
    ...
    <p className='description-info underline align-end'><a target="_blank" href='https://www.youtube.com/watch?v=jMMBhhSx214&t'><i class="fa-brands fa-youtube"></i> Click aquí</a></p>
    {/* Fin video */}

    <p className='description-info'>
        Hasta acá los <span className='mark-bold'>ejemplos didácticos</span> que te ofrecemos, pronto contaremos con más material para que aprendas, conozcas y disfrutes. <i class="fa-solid fa-thumbs-up"></i>
    </p>
</div>
  )
}
