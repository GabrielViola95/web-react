...
const VideosInfo = () => {
  return (
    <div className="Info-table">
            <h2 className='title-info-others'>Videos del Canal <i className="fa-brands fa-youtube"></i> </h2>
            ...
            <p className='description-info underline align-end'><a target="_blank" href="https://www.youtube.com/watch?v=--Hh2VKpLu0&t=1s"><i className="fa-brands fa-youtube"></i> Click aquí</a></p>
            {/* Fin video */}
            {/* Video */}
            ...
            <p className='description-info underline align-end'><a target="_blank" href="https://www.youtube.com/watch?v=pJgef-9qFXE"><i className="fa-brands fa-youtube"></i> Click aquí</a></p>
            {/* Fin video */}
            {/* Video */}
            ...
            <p className='description-info underline align-end'><a target="_blank" href="https://www.youtube.com/watch?v=x_bq9PvnclA"><i className="fa-brands fa-youtube"></i> Click aquí</a></p>
            {/* Fin video */}
            {/* Video */}
            ...
            <p className='description-info underline align-end'><a target="_blank" href="https://www.youtube.com/watch?v=eI0N21pa98E"><i className="fa-brands fa-youtube"></i> Click aquí</a></p>
            {/* Fin video */}
            ...
            <p className='description-info underline align-end'><a target="_blank" href='https://www.youtube.com/watch?v=tSbLsS4DnVM&t'><i className="fa-brands fa-youtube"></i> Click aquí</a></p>
            {/* Fin video */}

            <p className='description-info'>
                Hasta acá los <span className='mark-bold'>Videos</span> que te recomendamos, espero te haya resultado interesante. <i className="fa-solid fa-thumbs-up"></i>
            </p>
        </div>
  )
}
