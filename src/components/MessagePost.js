...
const MessagePost = ({ question, deletePost, id, autorEmail, autorName, imageProfile, PostId, Hour, Datte, uid }) => {
    ...
    const messageDocumentRef = collection(db, `msn`, `${PostId}`, `messages`);
    ...
    const createMessage = async () => {
      ...
      const deleteCmt = async (id) =>{
        ...
        const commentDoc = doc(db, `msn/${PostId}/messages`, id);
